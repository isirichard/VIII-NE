...
public class ReciboInactivar extends AppCompatActivity {
    ConexionSQLiteHelper conn;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recibo_inactivar);
        ...
        if(objetoEnviado!=null){
            ...
            values.put(UtilidadesRecibo.CAMPO_ESTADO_REGISTRO3,"I");
        ...
        Intent intent =new Intent(ReciboInactivar.this,ReciboListViewActivity.class);
