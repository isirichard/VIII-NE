...
public class CajeroInactivar extends AppCompatActivity {
    ConexionSQLiteHelper conn;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cajero_inactivar);
        ...
        if(objetoEnviado!=null){
            ...
            values.put(Utilidades.CAMPO_ESTADO_REGISTRO,"I");
        ...
        Intent intent =new Intent(CajeroInactivar.this,CajeroListViewActivity.class);
