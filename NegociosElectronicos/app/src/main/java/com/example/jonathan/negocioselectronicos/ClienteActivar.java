...
public class ClienteActivar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cliente_activar);
        ...
        if(objetoEnviado!=null){
            ...
            values.put(UtilidadesCliente.CAMPO_ESTADO_REGISTRO2,"A");
        ...
        Intent intent =new Intent(ClienteActivar.this,ClienteListViewActivity.class);
